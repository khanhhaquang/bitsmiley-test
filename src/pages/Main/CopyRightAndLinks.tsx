...
export const CopyRightAndLinks: React.FC = () => {
  ...
  return (
    <div
      className="fixed bottom-[90px] left-0 z-50 flex w-full origin-bottom items-center justify-between px-[136px] text-white mix-blend-difference"
      style={{
      ...
      <div
        className="flex origin-bottom-right items-center gap-x-6 font-bold"
        style={{
          scale: `${width >= 1920 ? 100 : (width * 100) / 1920}%`
        }}>
        <span
